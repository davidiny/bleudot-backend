    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('signature', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='main_calendar.Cal_User')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ('cal_user_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='main_calendar.Cal_User')),
                ('field', models.CharField(max_length=30)),
            ],
            bases=('main_calendar.cal_user',),
        ),
        migrations.CreateModel(
            name='Subscription',
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_calendar.Cal_User')),
            ],
        ),
        migrations.CreateModel(
            name='Rsvp',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('mailing_address', address.models.AddressField(on_delete=django.db.models.deletion.CASCADE, to='address.Address')),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
                ...
                ('receiver_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_calendar.Cal_User')),
            ],
        ),
        migrations.AddField(
            model_name='calendar',
