...
urlpatterns = [
    ...
    url(r'^api/calendars/$', CalendarList.as_view(), name='calendar-list'),
    url(r'^api/events/$', EventList.as_view(), name='event-list'),
    url(r'^api/organizations/$', OrganizationList.as_view(), name='organization-list'),
    path('api/calendars/<int:pk>', CalendarDetailView.as_view(), name='calendar-detail'),
